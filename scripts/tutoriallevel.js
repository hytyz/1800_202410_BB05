function displayCardsDynamically(collection) {
    let cardTemplate = document.getElementById("tutorialLevelTemplate"); // Retrieve the HTML element with the ID "hikeCardTemplate" and store it in the cardTemplate variable. 
    ...
    db.collection(collection).orderBy("levelNum").get()   //the collection called "hikes"
        .then(allLevel=> {
            ...
            allLevel.forEach(doc => { //iterate thru each doc
                ...
                var tutorialQuote = doc.data().tutorialQuote;  // get value of the "details" key
                ...
                newcard.querySelector('.card-text').innerHTML = tutorialQuote;
                newcard.querySelector('.card-image').src = `./images/${levelNum}.jpg`; //Example: NV01.jpg
                newcard.querySelector('a').href = "eachTutorialLevel.html?docID="+docID;
